...
final class AppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        panel.title = "PandaBert"; panel.isOpaque = false; panel.backgroundColor = .clear; panel.hasShadow = true
        ...
        let menu = NSMenu(); menu.addItem(withTitle: "Show PandaBert", action: #selector(showPanel), keyEquivalent: "")
        menu.addItem(withTitle: "Hide panel", action: #selector(hidePanel), keyEquivalent: "")
        menu.addItem(.separator()); menu.addItem(withTitle: "Quit PandaBert", action: #selector(quit), keyEquivalent: "q")

...
The artwork was generated from the supplied panda reference and refined for PandaBert. The final master has real alpha transparency: no grey or checkerboard background is included. These files and the README screenshots share the same master artwork.

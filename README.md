...
**Current version: 0.4.4 · Public preview · Apple Silicon · macOS 13+**
...
PandaBert reads accessible Claude Code and Codex session logs and converts recent events into task status. Repository information provides project grouping. Preferences, pins and a small cache stay in PandaBert's own local data folder.
